...
| Native macOS clients | one truthful unified Queue/History, global hold, captions, and identical text/file admission from interchangeable OS entry points | compile-separated Swift application ports, local-file/socket adapters, native Services/App Intents adapters, and menu presentation; UI and OS-integration designs | use-case fakes, isolated Services pasteboards, App Intent router tests, exact generated metadata, typed-to-wire projections, generated PDF cases, and installed no-audio caption-panel acceptance | representative host Services menu, live Accessibility, and real Shortcuts journeys remain absent |
