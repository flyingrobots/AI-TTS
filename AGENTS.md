...
The accepted, binding [Testing Standards](docs/standards/testing.md) apply to every automated assertion in this repository. The [AI-TTS testing profile](docs/standards/testing-profile.md) defines the local risk map, size ceilings, suite budget, and compliance ledger.
